...
/* find_lines */
var find_lines_div = document.getElementById('find_lines');
find_lines_div.onclick = function() {
    
    var ida = new image_data_acquire();

    var find_lines_args = '{null:null}';

    var src_ips = ida.get_image_process_info('src_canvas', 'find_lines', find_lines_args);
